        ...
        <form onSubmit={handleSubmit} className={styles.applicationForm}>
          ...
          <div className={styles.formSection}>
            ...
            <div className={styles.normalText}>
              Why are you interested in joining Helix, and what do you hope to gain from working with a startup in our incubator? (100 words soft max.)&nbsp;
            ...
            <div className={styles.normalText}>
              Tell us about something you&apos;ve built or contributed to that had a significant impact on you or others. (125 words soft max.) <span className={styles.required}>*</span>
            </div>
            ...
            <div className={styles.normalText}>
              Tell us about your future career goals (100 words soft max.) <span className={styles.required}>*</span>
            </div>
