            ...
            <div className={styles.applicationContent}>
                ...
                <div className={styles.applicationHeader}>
                    ...
                    <p className={styles.headerDescription}>
                        Are you a founder in the healthcare, digital health, or biotech space ready to fast-track your growth? We invite startups at any stage to apply, particularly those connected to
                        the Yale and New Haven community, including Yale alumni, graduate, and undergraduate students. Discover how the Yale Helix Incubator can be a valuable opportunity for your
                        team.
                    </p>
                </div>

                {/* Application Form - Using native form submission */}
                <form action="https://docs.google.com/forms/d/e/1FAIpQLSevkr4TYTGQqEGnNJP6nuQ4j9OvIt22NwKSTi9tvoTvelOyvA/formResponse" method="POST" target="_blank" className={styles.applicationForm}>
